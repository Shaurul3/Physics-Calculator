...
<body>
	...
	<div class="container d-flex align-items-center justify-content-center">
		<div class="row" style="background-color:#ffffff;">
			<a href="Mecanica.html" class="col-lg-6 col-sm-12 btn btn-primary btn-dark btn-outline-light"
				style="font-size: calc(1.525rem + 3vw);">Mecanică</a>
			<a href="Electricitate.html"
				class="col-lg-6 col-sm-12 btn btn-primary btn-dark btn-outline-light"
				style="font-size: calc(1.525rem + 3vw);">Electricitate</a>
			<a href="Termodinamica.html"
				class="col-lg-6 col-sm-12 btn btn-primary btn-dark btn-outline-light"
				style="font-size: calc(1.525rem + 3vw);">Termodinamică</a>
			<a href="Optica.html" class="col-lg-6 col-sm-12 btn btn-primary btn-dark btn-outline-light"
				style="font-size: calc(1.525rem + 3vw);">Optică</a>
		</div>
	</div>
