        ...
        <ul class="nav nav-tabs bg-dark nav-fill" id="myTab" role="tablist">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (isset($parametruVariabil) && !empty($parametruVariabil)) {
                    ...
                    FROM Fizician fiz
                    JOIN FizicianFundament ff ON fiz.FizicianID = ff.FizicianID
                    JOIN Fundament fu ON ff.FundamentID = fu.FundamentID
                    WHERE fu.FundamentID IN (
                        SELECT f.FundamentID
                        FROM Fundament f
                        JOIN Capitol c ON f.CapitolID = c.CapitolID
                        JOIN Ramura r ON c.RamuraID = r.RamuraID
